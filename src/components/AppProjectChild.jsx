const AppProjectChild = (props) => {
   ...
   const href = [
      'https://github.com/bqsst/person-type',
      'https://github.com/bqsst/Flutter-Profile-Interface',
      'https://github.com/bqsst/sc-auto-car-hatyai'
   ]

   return (
      <div>
         <a href={href[index]} target="_blank">
